...
local L = LibStub("AceLocale-3.0"):NewLocale("SageLootCouncil", "enUS", true, debug)
if not L then return end

L["A new session has begun, type '/slc open' to open the voting frame."] = true
L["Append realm names"] = true
L[" is not active in this raid."] = true
L["Now handles looting"] = true
L[" you are now the Master Looter and SageLootCouncil is now handling looting."] = true
...
L["Active"] = true
L["active_desc"] = "Uncheck to disable SageLootCouncil. Useful if you're in a raid group, but not actually participating. Note: This resets on every logout."
L["Add Item"] = true
L["Add Note"] = true
L["Add ranks"] = true
L["Add rolls"] = true
...
L["Always use SageLootCouncil when I'm Master Looter"] = true
...
L["auto_enable_desc"] = "Check to always let SageLootCouncil handle loot. Unchecking will make the addon ask if you want to use it every time you enter a raid or become Master Looter."
L["auto_loot_desc"] = "Enables autolooting of all equippable items"
L["auto_open_desc"] = "Check to Auto Open the voting frame when available. The voting frame can otherwise be opened with /slc open. Note: This requires permission from the Master Looter."
...
L["Candidate has disabled SageLootCouncil"] = true
...
L["chat tVersion string"] = "|cFF87CEFASageLootCouncil |cFFFFFFFFversion |cFFFFA500 %s - %s"
L["chat version String"] = "|cFF87CEFASageLootCouncil |cFFFFFFFFversion |cFFFFA500 %s"
L["chat_commands"] = [=[
...
L["Choose when to use SageLootCouncil"] = true
...
L["Close"] = true
L["config"] = true
L["confirm_usage_text"] = "|cFF87CEFA SageLootCouncil |r\n\nWould you like to use SageLootCouncil with this group?"
...
L["enable_loot_history_desc"] = "Enables the history. SageLootCouncil won't log anything if disabled."
...
L["ignore_input_desc"] = "Enter an itemID to add to the ignore list causing SageLootCouncil to never add the item to a session"
L["ignore_input_usage"] = "This function only accepts itemIDs (number)"
L["ignore_list_desc"] = "Items SageLootCouncil is ignoring. Click on a item to remove it."
L["ignore_options_desc"] = "Control which items SageLootCouncil should ignore. If you add an item that isn't cached, you need switch to another tab and back before you'll see it in the list."
L["ilvl"] = true
L["ilvl: x"] = "ilvl: %d"
...
L["loot_history_desc"] = "SageLootCouncil automatically records relevant information from sessions.\nThe raw data is stored in \".../SavedVariables/SageLootCouncil.lua\".\n\nNote: Non-MasterLooters can only store data sent from the MasterLooter.\n"
...
L["Name"] = true
L["Need"] = true
L["Never use SageLootCouncil"] = true
...
L["Officer"] = true
L["Offline or SageLootCouncil not installed"] = true
...
L["Raid"] = true
L["Rank"] = true
L["SageLootCouncil Loot Frame"] = true
L["SageLootCouncil Loot History"] = true
L["SageLootCouncil Session Setup"] = true
L["SageLootCouncil Version Checker"] = true
L["SageLootCouncil Voting Frame"] = true
L["Reannounce ..."] = true
L["Reason"] = true
...
L["Send History"] = true
L["send_history_desc"] = "Send data to everyone in the raid, regardless if you log it yourself. SageLootCouncil will only send data if you're the MasterLooter."
...
L["tVersion_outdated_msg"] = "Newest SageLootCouncil test version is: %s"
...
L["version_outdated_msg"] = "Your version %s is outdated. Newer version is %s, please update SageLootCouncil."
L["Vote"] = true
L["Voters"] = true
L["Votes"] = true
...
L["whisper"] = true
L["whisper_guide"] = "[SageLootCouncil]: number response [item1] [item2]. Link your item(s) that item (number) would replace, (response) being of the keywords below: Ex. '1 Greed [item1]' would greed on item #1"
L["whisper_guide2"] = "[SageLootCouncil]: You'll get a confirmation message if you were successfully added."
...
L["You haven't set a council! You can edit your council by typing '/slc council'"] = true
