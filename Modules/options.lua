-- options.lua - option frame in BlizOptions for SageLootCouncil
					...
					generalSettingsTab = {
						...
						args = {
							usage = {
								order = 1,
								name = L["Usage"],
								desc = L["Choose when to use SageLootCouncil"],
								type = "select",
								width = "double",
								values = {
									ml 			= L["Always use SageLootCouncil when I'm Master Looter"],
								--	leader 		= "Always use SageLootCouncil when I'm the group leader and enter a raid",
									ask_ml		= L["Ask me every time I become Master Looter"],
								--	ask_leader	= "Ask me every time I'm the group leader and enter a raid",
									never			= L["Never use SageLootCouncil"],
								},
								set = function(_, key)
							...
							ignoreOptions = {
								...
								args = {
									...
									ignoreInput = {
										...
										set = function(info, val) tinsert(self.db.profile.ignore, val); LibStub("AceConfigRegistry-3.0"):NotifyChange("SageLootCouncil") end,
									},
									ignoreList = {
										order = 3,
										name = L["Ignore List"],
...
function SageLootCouncil:DBGet(info)
	return self.db.profile[info[#info]]
end

function SageLootCouncil:DBSet(info, val)
